...
import NouvelleExpeditionForm from "./nouvelle-expedition-form";
  ...
  return (
    <div className="flex flex-col">
      <div className="flex items-end justify-between gap-6 border-b border-border bg-card px-[34px] pb-[18px] pt-6">
        <div className="text-[27px] font-bold tracking-tight text-navy-deep">Nouvelle expédition</div>
      </div>
      <div className="px-[34px] py-[26px]">
        <NouvelleExpeditionForm chauffeurs={chauffeurs} />
      </div>
    </div>
  );
}
